...
module hello::hello {
    ...
    public entry fun magic(self: &Sword): u64 {
        self.magic
    }

    public entry fun strength(self: &Sword): u64 {
        self.strength
    }

    public entry fun swords_created(self: &Forge): u64 {
        self.swords_created
    }
    ...
    fun test_sword_create() {
        ...
        assert!(
            sword.magic() == 42 && sword.strength() == 7,
            1
        );
